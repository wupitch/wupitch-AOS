...
enum class Sport(val no : Int, val sportName : Int, val color : Int,  val detailImage : Int, val thumbnailImage : Int) {
    ...
    HIKING(4, R.string.hiking,  R.color.purple_hiking,R.drawable.img_hike_thumb, R.drawable.img_hike),
    RUNNING(5, R.string.running, R.color.yellow_running,R.drawable.img_run_thumb, R.drawable.img_run);
