                ...
                WupitchTheme {
                        ...
                        SideEffect {
                            scope.launch {
                                scrollState.animateScrollTo(
                                    200.dpToInt(),
                                    FloatTweenSpec(250, 0, LinearEasing)
                                )
                            }
                        }
                    }
                    ...
                    ConstraintLayout(
                            ...
                            .padding(horizontal = 20.dp))
                        {
                            ...
                            Spacer(modifier = Modifier.height(32.dp))
                            CurrentCrewSize(crewSizeState, focusState)
